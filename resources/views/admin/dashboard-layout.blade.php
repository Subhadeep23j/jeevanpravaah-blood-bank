...
<body x-data="{ sidebarOpen: false }" class="bg-gray-50 text-gray-800 overflow-x-hidden">
    <div class="min-h-screen lg:flex">
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            class="fixed inset-y-0 left-0 z-50 w-72 bg-gradient-to-b from-red-600 to-red-700 text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 shadow-2xl flex flex-col flex-shrink-0">
        ...
        <div id="pageContent" class="flex flex-col flex-1 min-w-0 lg:ml-72">
                ...
                <div class="flex items-center justify-between px-5 py-3">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open"
                            class="flex items-center space-x-3 px-4 py-2 rounded-xl hover:bg-gray-100 transition-colors cursor-pointer">
                            <div
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <form action="{{ route('admin.logout') }}" method="POST">
                                @csrf
                                <button type="submit"
                                    class="block w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-gray-200 cursor-pointer">Logout</button>
                            </form>
                        </div>
                    </div>
                </div>
