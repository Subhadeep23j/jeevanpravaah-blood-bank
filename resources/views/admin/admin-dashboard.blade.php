    ...
    <div class="space-y-4 max-w-full">
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Blood Requests</p>
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ number_format($stats['total_blood_requests']) }}
                        </p>
                        <p class="text-xs text-{{ $stats['pending_blood_requests'] > 0 ? 'red' : 'green' }}-600 mt-1">
                            {{ $stats['pending_blood_requests'] }} pending</p>
                    </div>
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
